  ...
  return (
    <section id="contact" className="relative py-28">
      ...
      <div className="relative mx-auto max-w-4xl px-6">
        ...
        {/* unified glassmorphism contact card */}
        <motion.div
        ...
        >
          ...
          <div className="relative">
            <p className="mx-auto max-w-md text-center text-white/55">
            ...
            <div className="mt-10 grid grid-cols-1 gap-5 sm:grid-cols-2">
              {cards.map((c, i) => (
                <motion.div
                  ...
                  className="group relative flex items-center gap-4 rounded-2xl bg-white/[0.03] p-5 text-left transition hover:bg-white/[0.07]"
                >
